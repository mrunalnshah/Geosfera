...
class GuessCapitalFromCountry extends StatefulWidget {
  Region regionType;

  GuessCapitalFromCountry({super.key, required this.regionType});

  @override
  State<GuessCapitalFromCountry> createState() =>
      _GuessCapitalFromCountryState();
}

class _GuessCapitalFromCountryState extends State<GuessCapitalFromCountry> {
  String countryName = 'India';
  String optionA = 'Delhi';
  String optionB = 'Kabul';
  String optionC = 'Kathmandu';
  String optionD = 'Washington DC';
  ...
  void generateQuestion() {
    ...
    List<String> incorrectCountryNames = [
      incorrectCountries[0].capital,
      incorrectCountries[1].capital,
      incorrectCountries[2].capital,
    ];
    List<String> options = [
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Text("Guess Capital From Country"),
            IconButton(
              onPressed: () {
                ...
                children: [
                  ...
                  isAnswerChecked == false
                      ...
                      : Expanded(
                        flex: 3,
                        child:
                            selectedOption == correctCountry.capital
